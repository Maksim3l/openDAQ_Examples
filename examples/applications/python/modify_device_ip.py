...
def retrieve_ip_config(network_interface: daq.INetworkInterface):
    try:
...
def change_ip_config(device_info: daq.IDeviceInfo):
    ...
    config.set_property_value('address4', daq.String('192.168.56.166/24'))
    config.set_property_value('gateway4', daq.String('192.168.56.1'))
